...
#-------------------------------------------------------------
f_test_data = raw_input("Please Enter the name of the data file for prediction: \n")
cluster_val = input("Which Cluster do you want: For Small-Chi cluster enter 1 or For Large-Chi cluster enter 2:  \n")
#----------------------------------------------------------
